    ...
    <div className="flex flex-col gap-10 lg:gap-20 lg:flex-row lg:items-start lg:max-w-7xl lg:mx-auto">
      <div className="flex flex-col gap-5 bg-white rounded-xl shadow p-5 lg:py-8 lg:px-10 lg:w-8/12">
        ...
        <div>
          ...
          <p className="mt-3">
            You will’ll be part of an agile software development team, providing our customers with
            the most powerful platforms for analytics, mobility, and security. You will work in an
            environment with code reviews, CI with Git Hooks, as well as unit-tests and end-to-end
            automated tests.
          </p>
